...
export CFTN_DATA_ROOT="${CFTN_DATA_ROOT:-/workspace/volume/cftn-text/data/v2_broad_math_400k_r2}"
export CFTN_V2_MULTI_DATA_ROOT="${CFTN_V2_MULTI_DATA_ROOT:-/workspace/volume/cftn-text/data/v2_multi_specialist_r1}"
export CFTN_ARTIFACT_ROOT="${CFTN_ARTIFACT_ROOT:-/workspace/volume/cftn-text/artifacts/v2_broad_math_400k_r2}"
export HF_HOME="${HF_HOME:-/workspace/volume/cftn-text/cache/huggingface}"
export WANDB_PROJECT="${WANDB_PROJECT:-cftn-text-v2}"
export WANDB_GROUP="${WANDB_GROUP:-scaled-multi-specialist}"
