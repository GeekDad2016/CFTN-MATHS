...
$('stamp').textContent='Updated '+new Date(d.updated_unix*1000).toLocaleString()+' · refreshes every 10 seconds · '+(d.disk||[]).join('');let curr=curriculumState(d,status,live,rows,ep),assessment=trainingAssessment(d,p,a,issues,curr);
