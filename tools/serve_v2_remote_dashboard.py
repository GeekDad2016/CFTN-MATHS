...
if recovery_root is not None:
    ...
    training_contract = redact({
        ...
        "full_supervision": recovery_contract.get("format") in {"cftn_full_math_training_v1", "cftn_full_math_training_v2"},
        "competency_curriculum": recovery_contract.get("format") == "cftn_full_math_training_v2",
...
$('trend').innerHTML='<h3>Accuracy</h3>'+lineChart(accSeries,{zeroOne:true})+'<h3>Loss</h3>'+lineChart(lossSeries)+tbl(trendRows,['Epoch','Step','Train loss','Global val loss','Global token','Global exact trace','Phase panel','Phase answers','Broad retention','Selection','Best','Patience','LR','Curriculum','Epoch time']);
