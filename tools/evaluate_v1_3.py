...
from cftn_text.v1_3_evaluation import (
    ...
    evaluate_v1_3_causal_suite,
)
from cftn_text.wandb_support import add_wandb_arguments, wandb_options_from_args


def main() -> None:
    parser = argparse.ArgumentParser(description="Run the sealed V1.3 causal suite")
        ...
        json.dumps(
            evaluate_v1_3_causal_suite(
                ...
                wandb_options=wandb_options_from_args(
                    args, default_run_name="v1-3-sealed-causal-evaluation"
                ),
            ),
            indent=2,
        )
